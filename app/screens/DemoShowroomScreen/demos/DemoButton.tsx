...
const $customButtonPressedTextStyle: TextStyle = { color: colors.palette.neutral300 }
...
const $customButtonPressedRightAccessoryStyle: ImageStyle = { tintColor: colors.palette.neutral300 }
