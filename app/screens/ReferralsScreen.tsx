...
export const ReferralsScreen: FC<DemoTabScreenProps<"Referrals">> = function ReferralsScreen(
  _props,
) {
  ...
  return (
    <Screen preset="scroll" safeAreaEdges={["top"]} contentContainerStyle={$container}>
      ...
      <Text preset="h2" style={{ marginTop: 32, marginBottom: 8, marginLeft: 16 }}>
      ...
      >
        ...
        <View style={{ flex: 2, paddingLeft: 16 }}>
          <Text preset="overline" style={{ color: colors.palette.accent400 }}>
            Comisiones ganadas
          </Text>
          <Text preset="h3">0.0075 BTC</Text>
        </View>
        <View style={{ flex: 1 }}>
          <Text preset="overline" style={{ color: colors.palette.accent400 }}>
            Referidos
          </Text>
          <Text preset="h3">4</Text>
        </View>
        <View style={{ flex: 1, paddingRight: 16 }}>
          <Text preset="overline" style={{ color: colors.palette.accent400 }}>
            Ranking
          </Text>
          <Text preset="h3">3456</Text>
        </View>
      </View>
      <View>
        <View style={{ paddingHorizontal: 16 }}>
          <Text>ID de referido predeterminado</Text>
          <View style={{ flexDirection: "row", gap: 12, marginBottom: 20, paddingTop: 8 }}>
            <View
              style={{
                padding: 8,
                paddingRight: 40,
            ...
            >
              <Text preset="h3">87654356789</Text>
            </View>
            <TouchableOpacity
              style={{
      ...
      <View>
        <View style={{ paddingHorizontal: 16 }}>
          ...
          <View style={{ flexDirection: "row", gap: 12, marginBottom: 20, paddingTop: 8 }}>
            ...
            >
              <Text preset="h3" numberOfLines={1}>
                www.iescrow.com/....4366
              </Text>
            </View>
            <TouchableOpacity
              style={{
      ...
      <View style={[$divider, {marginTop: 32}]} />
      <Text preset="h2" style={{ marginTop: 32, marginBottom: 16, marginLeft: 16 }}>
        Amigos
      </Text>
      <View>
        <View style={{ flexDirection: "row", paddingBottom: 8, paddingHorizontal: 16 }}>
          <Text style={{ flex: 1 }} preset="h4">
            ID de usuario
          </Text>
          <Text style={{ flex: 1 }} preset="h4">
        ...
        <View
          style={{
            flexDirection: "row",
            padding: 16,
            borderBottomColor: colors.palette.lineGray,
            borderBottomWidth: 1,
          }}
        >
          <View style={{ flexDirection: "row", gap: 16, flex: 1 }}>
            <AutoImage
              ...
              style={{ tintColor: colors.palette.accent400, width: 16, height: 16 }}
            />
            <Text preset="h4">123456</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text preset="h4">0.0002 BTC</Text>
          </View>
        </View>
        <View
          style={{
